        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
            {departmentData.map((data, index) => {
              ...
              return (
                <Card key={index} className="group bg-white cursor-pointer transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_8px_35px_rgba(8,145,178,0.2)] border border-slate-50 hover:border-b-4 hover:border-b-cyan-600">
