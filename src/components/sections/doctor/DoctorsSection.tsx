...
const doctors = [
  {
    ...
    imagesrc: "https://img.magnific.com/free-photo/cheerful-medic-standing-with-arms-crossed_23-2147767252.jpg?t=st=1780582442~exp=1780586042~hmac=f8f89a05a39a0ee6d7c5d4a1882b0bde7c3811847b976c70f48e5365883a465e&w=2000",
  },
  {
    id: 2,
    name: "Dr. Faiz",
    ...
    <>
      <section className="bg-white py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 md:mt-20 mt-10">
              ...
              return (
                <Card key={index} className="group cursor-pointer transition-all duration-300 hover:border-b-4 hover:border-b-cyan-600 hover:bg-cyan-700/5 bg-gray-100/55  border border-cyan-700/10">
                  ...
                  <div className="p-8">
                    ...
                    <Paragraph size="xs" variant="primary" className="font-semibold">
                      {data.desingnation}
                    </Paragraph>
                    <CardContent className="text-sm  text-gray-500">{data.bio}</CardContent>
                    <button onClick={() => handleClick(index)} className="card-outline-btn mt-5">
                      {data.redoc}
                      {Icon && (
                        <span className={`transition-transform duration-300 ${clicked === index ? "translate-x-2" : ""}`}>
                          <Icon size={10} />
                        </span>
                      )}
                    </button>
