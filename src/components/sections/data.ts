...
export const departmentData: DataTypes[] = [
  {
    id: 1,
    title: "Neurology",
    description: "Comprehensive diagnosis and treatment for disorders of the brain, spinal cord, and nervous system.",
    imagesrc:
      "https://img.magnific.com/free-photo/male-radiologist-analyzing-mri-scan-results-patient-computer-monitor-control-room_637285-5158.jpg?t=st=1780505067~exp=1780508667~hmac=bb2e247da241ab5b19577106837692494bfc5ccbef397778a99704c6e8d9476f&w=1480",
    redoc: "Read More",
  ...
  },
  {
    id: 2,
    title: "Cardiology",
    description: "Advanced heart care services including diagnosis, treatment, and preventive cardiology.",
  ...
  },
  {
    id: 3,
    title: "Dental Care",
    description: "Professional dental treatments, cosmetic dentistry, oral surgery, and routine checkups.",
  ...
  },
  {
    ...
    imagesrc:
      "https://img.magnific.com/free-photo/happy-female-doctor-giving-high-fie-little-boy-who-came-with-father-hospital_637285-492.jpg?t=st=1780505183~exp=1780508783~hmac=83a87f948f9280c9a410fa2393bb1be3e1aa52e5ddfe3887bbbf8454e99c3495&w=1480",
    redoc: "Read More",
    icon: icon.rightArrow,
  },
  {
    ...
    description: "Expert care for bones, joints, ligaments, and musculoskeletal conditions.",
  ...
  },
  {
    id: 6,
    title: "Ophthalmology",
    description: "Comprehensive eye care services including vision testing and eye disease treatment.",
  ...
  },
  {
    id: 7,
    title: "Dermatology",
    description: "Specialized treatments for skin, hair, and nail conditions using modern techniques.",
  ...
  },
  {
    ...
    description: "24/7 emergency medical assistance with rapid response and critical care support.",
